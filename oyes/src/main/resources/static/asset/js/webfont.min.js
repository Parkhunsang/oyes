!(function () {
  ...
  function G(t, n, i) {
    (this.c = t || n + K), (this.a = []), (this.f = []), (this.g = i || "");
  }
  ...
  var K = "//fonts.googleapis.com/css";
  function R(t) {
  ...
  var nt = new t(window);
  (nt.a.c.custom = function (t, n) {
    return new z(n, t);
  }),
    (nt.a.c.fontdeck = function (t, n) {
      return new tt(n, t);
    }),
    (nt.a.c.monotype = function (t, n) {
      return new M(n, t);
    }),
    (nt.a.c.typekit = function (t, n) {
      return new Z(n, t);
    }),
    (nt.a.c.google = function (t, n) {
      return new X(n, t);
    });
  var it = { load: p(nt.load, nt) };
  "function" == typeof define && define.amd
    ...
    ? (module.exports = it)
    : ((window.WebFont = it),
      window.WebFontConfig && nt.load(window.WebFontConfig));
})();
